...
&& !empty($_POST['pwd']))
{
	...
	$query = "SELECT * FROM user_tbl WHERE email ='$email' AND pwd ='$password'";
	...
	if($total  == 1)
	{
		...
		header("location:/fs/welcome.php");
	}
	else{
		{
...
<form action="" class="signup-form" method="Post">
  <div class="mb-3">
  <h3 class="mt-0 pb-4 text-center" id="title4">User Login </h3>
  <a href="index.php"class="rs">Ragistration Form</a><br><br>
